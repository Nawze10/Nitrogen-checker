...
dP     dP                      .88888.                                                  
88     88                     d8'   `88                                                 
88    .8P d888888b 88d8b.d8b. 88        .d8888b. 88d888b.    dP.  .dP dP    dP d888888b 
88    d8'    .d8P' 88'`88'`88 88   YP88 88ooood8 88'  `88     `8bd8'  88    88    .d8P' 
88  .d8P   .Y8P    88  88  88 Y8.   .88 88.  ... 88    88 dP  .d88b.  88.  .88  .Y8P    
888888'   d888888P dP  dP  dP  `88888'  `88888P' dP    dP 88 dP'  `dP `8888P88 d888888P 
                                                                           .88          
                                                                       d8888P                            

Ce logiciel a été re-Coder et rectifié par VzmGen.xyz
Copyright © 2022 VzmGen
...
class NitroGen: # Initialiser la classe
    ...
    def main(self): # La fonction principale contient le code le plus important
        ...
        if os.name == "nt": # Si le système est Windows
            print("")
            ctypes.windll.kernel32.SetConsoleTitleW("MinatoVzm | Nitro Generator and Checker") # Changer le
        else: # Ou si c'est unix
            print(f'\33]0;MinatoVzm | Nitro Generator and Checker\a', end='', flush=True) # Mettre à jour le titre du cmd
...
888888'   d888888P dP  dP  dP  `88888'  `88888P' dP    dP 88 dP'  `dP `8888P88 d888888P 
        ...
        for i in range(num): # Boucle sur le nombre de codes à vérifier
            ...
            if os.name == "nt": # Si le système est Windows
                ctypes.windll.kernel32.SetConsoleTitleW(f"VzmGen | Nitro Generator and Checker - {len(valide)} Valide | {invalide} Invalide ") # Modifier le titre du cmd
                print("")
